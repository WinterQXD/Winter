...
public interface SelecterDao {
//	 根据题目顺序查找选项的值 返回一个结果集

	public List listSelecterBySeq(int seq, int oid) ;
	
//	 插入选项
	public int addSelecter(int oid, int seq, String content, int seq_selecter,int score) ;
...
//	 传进来问卷编号和试题的顺序号 删除该题所对应的选项表中的数据
	...
	Selecter getselscoreBySeq(int seq, int qseq, int oid);
