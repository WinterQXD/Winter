...
<%
			...
			ObjectBean ob =   objdao.findObjectBeanByID(oid);
			int state = ob.getState();
			if (state == 1 || state == 2) {
		    //清空回复表中的数据
		    ReplayDao replydao =(ReplayDao)BeansFactory.get("replayDao");
		    replydao.delReplay(oid);
		    //修改问卷状态为草稿
...
function addTextBox(form, afterElement) {
		...
		var txtfName = "txtf" + textNumber;
		var txtfId = "txtf" + textNumber; 
		...
		var scoreName = "score" + textNumber;
		var scoreId = "score" + textNumber;
		var scorefName = "scoref" + textNumber;
		var scorefId = "scoref" + textNumber; 
		cellText.innerHTML = "<input type='text' name='" + scoreName + "' id='" + scoreId + "' style=\"width:100px;\"/> ";
}
...
<body topmargin="2">
		<table cellspacing="0" cellpadding="0" width="400" align="center" class="tab">
			<tbody>
				<tr>
					<td height="30"></td>
				</tr>
			...
			<table width="600" border="0" align="center" cellpadding="2"  cellspacing="1" id="myTable" class="tab">
				...
				<tr>
					...
					<td>
						...
						<!-- 分值：<input type="text" name="score"  style="width:100px;" value="1"/>
						正确选项 <input type="text" name="rightvalue"  style="width:100px;" /> -->
					</td>
				</tr>
				<tr>
					<td valign="top">
				...
				<tr>
					...
					<td>
						<input type="text" name="score1" id="score1"  style="width:100px;" />
					</td>
				</tr>
				<tr>
					<td>
					...
					<td id="td1">
						<input type="button" value="添加选项 " id="add" onclick="addTextBox(this.form,this.parentNode)" class="btn"/>
