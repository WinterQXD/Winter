...
<%
	...
	String savePath = request.getSession().getServletContext().getRealPath("/") + "/describe/"; 
	//文件保存目录URL /zswz/attached/ 
	String saveUrl = request.getContextPath() + "/describe/"; 
	...
	String ymd = sdf.format(new Date()); savePath += ymd + "/";//D:\Tomcat6.0\webapps\zswz\attached/image/20111129/ 
	...
	obj.put("error", 0); 
	obj.put("url", saveUrl +"/" + newImgName); ///zswz/attached/image/20111129/  image 20111129195421_593.jpg 
