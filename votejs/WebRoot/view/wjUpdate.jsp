...
<html>
	...
	<body leftmargin="8" topmargin="8">
		<form action="wjupdate.action" name="fm" method="post">
		<input type="hidden" name="createUser" value="<%=session.getAttribute("userName")%>" />
		<input type="hidden" name="oid" value="${ob.oid}" />
		<table width="100%" align="center" class="table">
			...
			<table width="100%" align="center" class="table">
				<tr>
					...
					<td>
						&nbsp;
						<input type="text" name="title" style="width:350px" value="${ob.title}" />
					</td>
				</tr>
				<tr>
					...
					<td>
						&nbsp;
						<textarea name="discribe" cols="100" rows="15" >${ob.discribe}</textarea>
					</td>
				</tr>
				<tr>
					<td height="30" align="right">
					...
					<td>
						是<input name="anonymousFlag" type="radio" value="1"    <c:if test="${'1'==ob.anonymousFlag}">checked</c:if>     />&nbsp;&nbsp; 
                                                                否<input name="anonymousFlag" type="radio" value="0"   <c:if test="${'0'==ob.anonymousFlag}">checked</c:if>    />
					</td>
				</tr>
				<tr>
				<td height="30" ></td>
