...
<LINK href="<%=request.getContextPath()%>/view/images/public.css" type=text/css rel=stylesheet>
<LINK href="<%=request.getContextPath()%>/view/images/login.css" type=text/css rel=stylesheet>
          ...
          <TABLE height="100%" cellSpacing=0 cellPadding=0 width="100%">
            <TBODY>
              ...
              <TR height=30>
                ...
                <TD>用户名：</TD>
                <TD>
                  <INPUT class=textbox id=txtUserName name=username value="">
                </TD>
                <TD width=120>&nbsp;</TD>
              </TR>
              <TR height=40>
                <TD>密　码：</TD>
                <TD>
                  <INPUT class=textbox id=txtUserPassword type=password name=password value="">
                </TD>
                <TD width=120>&nbsp;</TD>
              </TR>
